...
>
  ...
  className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-semibold py-2 px-6 rounded-full transition-transform duration-300 text-sm inline-flex items-center ml-[-64px]" // Más a la izquierda
  whileHover={{ scale: 1.05 }} // Efecto de ampliación
